...
<a name="array_subscript-0" href="#array_subscript-0">#</a> <code><i>value_type</i> &</code> **operator[]** (<code>const <i>key_type</i> &<b>key</b></code>) [<>](../../../src/binary_tree/base.hpp#L)<br>
